...
RED_SPACE_SHIP = pygame.image.load(
    os.path.join(IMG_DIR, "pixel_ship_red_small.png")
)
GREEN_SPACE_SHIP = pygame.image.load(
    os.path.join(IMG_DIR, "pixel_ship_green_small.png")
)
BLUE_SPACE_SHIP = pygame.image.load(
    os.path.join(IMG_DIR, "pixel_ship_blue_small.png")
)
...
YELLOW_LASER = pygame.image.load(
    os.path.join(IMG_DIR, "pixel_laser_yellow.png")
)

# Background
BG = pygame.transform.scale(
    pygame.image.load(os.path.join(IMG_DIR, "background-black.png")),
    (WIDTH, HEIGHT),
)
