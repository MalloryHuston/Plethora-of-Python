...
def checkGrid0(grid):
    ...
    if grid[0][0] == "O" and grid[1][0] == "O" and grid[2][0] == "O":
        RowMsg = "Three 0s in a Column."
        text2 = font.render(RowMsg, True, (0, 0, 0))
        print("Three 0s in a Column.")
        # Winner = True
        screen.blit(text2, text_rect2)
        # Render the text
        text3 = font.render("Press R to restart", True, (0, 0, 0))
...
grid = [
    ...
    [" ", " ", " "],
    [" ", " ", " "],
]  # Creates the Console Representation of the Grid
Turn = True  # Determines whether it is X or Os turn
# Winner = False
...
while running:
    ...
    for event in pygame.event.get():
        ...
        # Mouse Detection
        # Checks For mouse clicking within each square
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            if G00.collidepoint(pygame.mouse.get_pos()):
                ...
                col = 0
                if (
                    "X" in grid[0][0] or "O" in grid[0][0]
                ):  # Checks wether the grid is empty
                    print("stop")
                else:
                    if Turn is True:
                        grid[row][col] = "X"
        ...
        # Checks whether you pressed the X button to quit
