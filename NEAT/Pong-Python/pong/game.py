...
class Game:
    """
    To use this class simply initialize and instance and call
    the .loop() method inside of a pygame event loop (i.e while loop).
    Inside of your event loop, you can call the .draw() and .move_paddle()
    methods according to your use case. Use the information returned from
    .loop() to determine when to end the game by calling .reset().
    """
    ...
    def _handle_collision(self):
        ...
        if ball.x_vel < 0:
            if (
                ...
                and ball.y <= left_paddle.y + Paddle.HEIGHT
            ):
            ...
            if (
                ...
                and ball.y <= right_paddle.y + Paddle.HEIGHT
            ):
    ...
    def move_paddle(self, left=True, up=True):
        ...
        if left:
            ...
            if (
                not up
                and self.left_paddle.y + Paddle.HEIGHT > self.window_height
            ):
                return False
            ...
            if (
                not up
                and self.right_paddle.y + Paddle.HEIGHT > self.window_height
            ):
                return False
